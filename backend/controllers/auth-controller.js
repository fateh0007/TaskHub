...
const registerUser = async (req,res) => {
    ...
    try {
        ...
        //Using arcjet to check if the email is correct one
        ...
        const emailBody = `<h1>Please verify your email</h1><p>Click the link below to verify your email address</p><a href="${verificationLink}">${verificationLink}</a>`;
...
const resetPasswordRequest = async (req, res) => {
    try {
        ...
        const emailBody = `<p>Click <a href="${resetPasswordLink}">here</a> to reset your password. The link will expire in 15 minutes.</p>`;
